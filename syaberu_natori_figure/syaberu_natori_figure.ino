...
uint8_t DEVICE_ADDRESS = 0x1D; //If SDO=L, 0x53
SoftwareSerial Serial1(3, 2); //TX&RX for MP3VoiceModule
int zoffset = 270; //Offset on z-axis gravity
int th = 14; //Threshold for tapping
int tiltth =170; // Threshold for tilt
...
//ADXL345
  ...
  Wire.write(0x08); //Max Resolution & Range of 16g
